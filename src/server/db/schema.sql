...
CREATE TABLE IF NOT EXISTS campaigns (
    ...
    target_completions INTEGER NOT NULL DEFAULT 50 CHECK (target_completions > 0),
    ...
    total_budget INTEGER NOT NULL DEFAULT 50 CHECK (total_budget >= 0),
    spent_budget INTEGER NOT NULL DEFAULT 0 CHECK (spent_budget >= 0),
    remaining_budget INTEGER NOT NULL DEFAULT 50 CHECK (remaining_budget >= 0),
